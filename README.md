...
| hommItemsMintManyArtifacts      | Mints a bunch of new artifacts with the `metadataCIDs` to the `to` address                                    | --contract-address => An address of a contract</br>--metadata-identifiers => The artifacts metadata CIDs of v1</br>--to => The recipient address                                                                                                |
